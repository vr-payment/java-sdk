# VR Payment Java Library

The VR Payment Java library wraps around the VR Payment API. This library facilitates your interaction with various services such as transactions, accounts, and subscriptions.
...
```groovy
compile "de.vr_payment:vrpayment-java-sdk:9.0.0"
```
...
* `target/vrpayment-java-sdk-9.0.0.jar`
* `target/lib/*.jar`
...
```java
package de.vr_payment.sdk.example;

import de.vr_payment.sdk.ApiClient;
import de.vr_payment.sdk.service.TransactionService;
