...
import com.vrpayment.sdk.model.WebAppConfirmationResponse;
...
public class WebAppsService extends BaseApi {
   ...
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getWebAppsInstalled">Check whether the web app is installed Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#postWebAppsConfirmCode">Confirm a web app installation Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#postWebAppsUninstall">Uninstall a web app Documentation</a>
   */
