...
public class HumanUsersRolesService extends BaseApi {
   ...
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#deleteHumanUsersUserIdAccountRoles">Unassign a role from a human user for an account Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#deleteHumanUsersUserIdSpaceRoles">Unassign a role from a human user for a space Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getHumanUsersUserIdAccountRoles">List all roles of a human user for an account Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getHumanUsersUserIdSpaceRoles">List all roles of a human user for a space Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#postHumanUsersUserIdAccountRoles">Assign a role to a human user for an account Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#postHumanUsersUserIdSpaceRoles">Assign a role to a human user for a space Documentation</a>
   */
