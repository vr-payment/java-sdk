...
import com.vrpayment.sdk.model.SubscriptionPeriodBill;
import com.vrpayment.sdk.model.SubscriptionPeriodBillListResponse;
import com.vrpayment.sdk.model.SubscriptionPeriodBillSearchResponse;
...
public class SubscriptionPeriodBillsService extends BaseApi {
   ...
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getSubscriptionsPeriodBills">List all subscription period bills Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getSubscriptionsPeriodBillsId">Retrieve a subscription period bill Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getSubscriptionsPeriodBillsSearch">Search subscription period bills Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#postSubscriptionsPeriodBillsIdClose">Close a subscription period bill Documentation</a>
   */
