...
import com.vrpayment.sdk.model.AnalyticsQueryExecutionRequest;
import com.vrpayment.sdk.model.AnalyticsQueryExecutionResponse;
import com.vrpayment.sdk.model.RestApiErrorResponse;
import com.vrpayment.sdk.model.ResultPortionModel;
import com.vrpayment.sdk.model.SubmittedAnalyticsQueryExecution;
...
public class AnalyticsQueriesService extends BaseApi {
   ...
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#deleteAnalyticsQueriesQueryExternalIdQueryExternalId">Cancel a query execution, identifying it by its external id. Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#deleteAnalyticsQueriesQueryTokenQueryToken">Cancel a query execution, identifying it by its query token. Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getAnalyticsQueries">Get portion of query executions for account Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getAnalyticsQueriesQueryExternalIdQueryExternalId">Retrieve a query execution information by its external id Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getAnalyticsQueriesQueryExternalIdQueryExternalIdResult">Generate a temporary URL to download the query result. It retrieves the query by its external id Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getAnalyticsQueriesQueryTokenQueryToken">Retrieve a query execution information by its query token Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getAnalyticsQueriesQueryTokenQueryTokenResult">Generate a temporary URL to download the query result. It retrieves the query by its query token Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#postAnalyticsQueriesSubmit">Submit a query execution Documentation</a>
   */
