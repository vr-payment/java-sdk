...
import com.vrpayment.sdk.model.Space;
import com.vrpayment.sdk.model.SpaceCreate;
import com.vrpayment.sdk.model.SpaceListResponse;
import com.vrpayment.sdk.model.SpaceSearchResponse;
import com.vrpayment.sdk.model.SpaceUpdate;
...
public class SpacesService extends BaseApi {
   ...
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#deleteSpacesId">Delete a space Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getSpaces">List all spaces Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getSpacesId">Retrieve a space Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getSpacesSearch">Search spaces Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#patchSpacesId">Update a space Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#postSpaces">Create a space Documentation</a>
   */
