...
import com.vrpayment.sdk.model.Account;
import com.vrpayment.sdk.model.AccountCreate;
import com.vrpayment.sdk.model.AccountListResponse;
import com.vrpayment.sdk.model.AccountSearchResponse;
import com.vrpayment.sdk.model.AccountUpdate;
...
public class AccountsService extends BaseApi {
   ...
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#deleteAccountsId">Delete an account Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getAccounts">List all accounts Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getAccountsId">Retrieve an account Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getAccountsSearch">Search accounts Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#patchAccountsId">Update an account Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#postAccounts">Create an account Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#postAccountsIdActivate">Activate an account Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#postAccountsIdDeactivate">Deactivate an account Documentation</a>
   */
