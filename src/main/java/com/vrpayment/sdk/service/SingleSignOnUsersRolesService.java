...
import com.vrpayment.sdk.model.UserAccountRole;
import com.vrpayment.sdk.model.UserAccountRoleListResponse;
import com.vrpayment.sdk.model.UserSpaceRole;
import com.vrpayment.sdk.model.UserSpaceRoleListResponse;
...
public class SingleSignOnUsersRolesService extends BaseApi {
   ...
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#deleteSingleSignOnUsersUserIdAccountRoles">Unassign a role from a single sign-on user for an account Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#deleteSingleSignOnUsersUserIdSpaceRoles">Unassign a role from a single sign-on user for a space Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getSingleSignOnUsersUserIdAccountRoles">List all roles of a single sign-on user for an account Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getSingleSignOnUsersUserIdSpaceRoles">List all roles of a single sign-on user for a space Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#postSingleSignOnUsersUserIdAccountRoles">Assign a role to a single sign-on user for an account Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#postSingleSignOnUsersUserIdSpaceRoles">Assign a role to a single sign-on user for a space Documentation</a>
   */
