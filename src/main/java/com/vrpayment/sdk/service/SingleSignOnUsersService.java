...
import com.vrpayment.sdk.model.SingleSignOnUser;
import com.vrpayment.sdk.model.SingleSignOnUserCreate;
import com.vrpayment.sdk.model.SingleSignOnUserListResponse;
import com.vrpayment.sdk.model.SingleSignOnUserSearchResponse;
import com.vrpayment.sdk.model.SingleSignOnUserUpdate;
...
public class SingleSignOnUsersService extends BaseApi {
   ...
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#deleteSingleSignOnUsersId">Delete a single sign-on user Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getSingleSignOnUsers">List all single sign-on users Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getSingleSignOnUsersId">Retrieve a single sign-on user Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getSingleSignOnUsersSearch">Search single sign-on users Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#patchSingleSignOnUsersId">Update a single sign-on user Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#postSingleSignOnUsers">Create a single sign-on user Documentation</a>
   */
