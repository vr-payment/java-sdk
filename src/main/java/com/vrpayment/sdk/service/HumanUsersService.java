...
import java.io.File;
import com.vrpayment.sdk.model.HumanUser;
import com.vrpayment.sdk.model.HumanUserCreate;
import com.vrpayment.sdk.model.HumanUserListResponse;
import com.vrpayment.sdk.model.HumanUserSearchResponse;
import com.vrpayment.sdk.model.HumanUserUpdate;
...
public class HumanUsersService extends BaseApi {
   ...
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#deleteHumanUsersId">Delete a human user Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getHumanUsers">List all human users Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getHumanUsersExport">Export human users Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getHumanUsersId">Retrieve a human user Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getHumanUsersSearch">Search human users Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#patchHumanUsersId">Update a human user Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#postHumanUsers">Create a human user Documentation</a>
   */
