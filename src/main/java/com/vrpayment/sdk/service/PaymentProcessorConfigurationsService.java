...
import com.vrpayment.sdk.model.PaymentProcessorConfiguration;
import com.vrpayment.sdk.model.PaymentProcessorConfigurationActive;
import com.vrpayment.sdk.model.PaymentProcessorConfigurationCreate;
import com.vrpayment.sdk.model.PaymentProcessorConfigurationListResponse;
import com.vrpayment.sdk.model.PaymentProcessorConfigurationSearchResponse;
...
public class PaymentProcessorConfigurationsService extends BaseApi {
   ...
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#deletePaymentProcessorConfigurationsId">Delete a payment processor configuration Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getPaymentProcessorConfigurations">List all payment processor configurations Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getPaymentProcessorConfigurationsId">Retrieve a payment processor configuration Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getPaymentProcessorConfigurationsSearch">Search payment processor configurations Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#patchPaymentProcessorConfigurationsId">Update a payment processor configuration Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#postPaymentProcessorConfigurations">Create a payment processor configuration Documentation</a>
   */
