...
import com.vrpayment.sdk.model.Customer;
import com.vrpayment.sdk.model.CustomerActive;
import com.vrpayment.sdk.model.CustomerCreate;
import com.vrpayment.sdk.model.CustomerEmailAddressListResponse;
import com.vrpayment.sdk.model.CustomerListResponse;
import com.vrpayment.sdk.model.CustomerSearchResponse;
import com.vrpayment.sdk.model.RestApiBulkOperationResult;
...
public class CustomersService extends BaseApi {
   ...
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#deleteCustomersBulk">Delete multiple customers Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#deleteCustomersId">Delete a customer Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getCustomers">List all customers Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getCustomersId">Retrieve a customer Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getCustomersIdEmailAddresses">List a customer&#39;s email addresses Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getCustomersSearch">Search customers Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#patchCustomersBulk">Update multiple customers Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#patchCustomersId">Update a customer Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#postCustomers">Create a customer Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#postCustomersBulk">Create multiple customers Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#postCustomersIdMergeOther">Merge two customers Documentation</a>
   */
