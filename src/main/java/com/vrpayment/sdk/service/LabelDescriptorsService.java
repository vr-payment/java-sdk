...
import com.vrpayment.sdk.model.LabelDescriptor;
import com.vrpayment.sdk.model.LabelDescriptorGroup;
import com.vrpayment.sdk.model.LabelDescriptorGroupListResponse;
import com.vrpayment.sdk.model.LabelDescriptorGroupSearchResponse;
import com.vrpayment.sdk.model.LabelDescriptorListResponse;
import com.vrpayment.sdk.model.LabelDescriptorSearchResponse;
...
public class LabelDescriptorsService extends BaseApi {
   ...
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getLabelDescriptors">List all label descriptors Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getLabelDescriptorsGroups">List all label descriptor groups Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getLabelDescriptorsGroupsId">Retrieve a label descriptor group Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getLabelDescriptorsGroupsSearch">Search label descriptor groups Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getLabelDescriptorsId">Retrieve a label descriptor Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getLabelDescriptorsSearch">Search label descriptors Documentation</a>
   */
