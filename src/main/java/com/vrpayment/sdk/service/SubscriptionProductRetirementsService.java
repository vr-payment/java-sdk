...
import com.vrpayment.sdk.model.ProductRetirementListResponse;
import com.vrpayment.sdk.model.ProductRetirementSearchResponse;
...
public class SubscriptionProductRetirementsService extends BaseApi {
   ...
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getSubscriptionsProductsRetirements">List all product retirements Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getSubscriptionsProductsRetirementsId">Retrieve a product retirement Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getSubscriptionsProductsRetirementsSearch">Search product retirements Documentation</a>
   */
