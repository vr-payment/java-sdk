...
import com.vrpayment.sdk.model.ChargeAttemptListResponse;
import com.vrpayment.sdk.model.ChargeAttemptSearchResponse;
...
public class ChargeAttemptsService extends BaseApi {
   ...
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getPaymentChargeAttempts">List all charge attempts Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getPaymentChargeAttemptsId">Retrieve a charge attempt Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getPaymentChargeAttemptsSearch">Search charge attempts Documentation</a>
   */
