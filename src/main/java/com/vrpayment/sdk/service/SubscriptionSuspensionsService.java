...
import com.vrpayment.sdk.model.SuspensionListResponse;
import com.vrpayment.sdk.model.SuspensionSearchResponse;
...
public class SubscriptionSuspensionsService extends BaseApi {
   ...
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getSubscriptionsSuspensions">List all suspensions Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getSubscriptionsSuspensionsId">Retrieve a suspension Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getSubscriptionsSuspensionsSearch">Search suspensions Documentation</a>
   */
