...
import com.vrpayment.sdk.model.BankAccount;
import com.vrpayment.sdk.model.BankAccountListResponse;
import com.vrpayment.sdk.model.BankAccountSearchResponse;
...
public class BankAccountsService extends BaseApi {
   ...
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getPaymentBankAccounts">List all bank accounts Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getPaymentBankAccountsId">Retrieve a bank account Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getPaymentBankAccountsSearch">Search bank accounts Documentation</a>
   */
