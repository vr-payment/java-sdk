...
import com.vrpayment.sdk.model.ProductSetupFee;
import com.vrpayment.sdk.model.ProductSetupFeeListResponse;
import com.vrpayment.sdk.model.ProductSetupFeeSearchResponse;
import com.vrpayment.sdk.model.ProductSetupFeeUpdate;
...
public class SubscriptionProductSetupFeesService extends BaseApi {
   ...
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#deleteSubscriptionsProductsSetupFeesId">Delete a setup fee Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getSubscriptionsProductsSetupFees">List all setup fees Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getSubscriptionsProductsSetupFeesId">Retrieve a setup fee Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getSubscriptionsProductsSetupFeesSearch">Search setup fees Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#patchSubscriptionsProductsSetupFeesId">Update a setup fee Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#postSubscriptionsProductsSetupFees">Create a setup fee Documentation</a>
   */
