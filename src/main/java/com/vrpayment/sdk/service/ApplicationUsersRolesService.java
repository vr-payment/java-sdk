...
public class ApplicationUsersRolesService extends BaseApi {
   ...
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#deleteApplicationUsersUserIdAccountRoles">Unassign a role from an application user for an account Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#deleteApplicationUsersUserIdSpaceRoles">Unassign a role from an application user for a space Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getApplicationUsersUserIdAccountRoles">List all roles of an application user for an account Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getApplicationUsersUserIdSpaceRoles">List all roles of an application user for a space Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#postApplicationUsersUserIdAccountRoles">Assign a role to an application user for an account Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#postApplicationUsersUserIdSpaceRoles">Assign a role to an application user for a space Documentation</a>
   */
