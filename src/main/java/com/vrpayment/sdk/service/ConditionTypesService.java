...
import com.vrpayment.sdk.model.ConditionType;
import com.vrpayment.sdk.model.ConditionTypeListResponse;
import com.vrpayment.sdk.model.ConditionTypeSearchResponse;
...
public class ConditionTypesService extends BaseApi {
   ...
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getPaymentConditionTypes">List all condition types. Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getPaymentConditionTypesId">Retrieve a condition type. Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getPaymentConditionTypesSearch">Search condition types. Documentation</a>
   */
