...
import com.vrpayment.sdk.model.MetricUsageReportListResponse;
import com.vrpayment.sdk.model.MetricUsageReportSearchResponse;
import com.vrpayment.sdk.model.RestApiErrorResponse;
import java.util.Set;
import com.vrpayment.sdk.model.SortingOrder;
import com.vrpayment.sdk.model.SubscriptionMetricUsageReport;
import com.vrpayment.sdk.model.SubscriptionMetricUsageReportCreate;
...
public class SubscriptionMetricUsageReportsService extends BaseApi {
   ...
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getSubscriptionsMetricUsageReports">List all metric usage reports Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getSubscriptionsMetricUsageReportsId">Retrieve a metric usage report Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getSubscriptionsMetricUsageReportsSearch">Search metric usage reports Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#postSubscriptionsMetricUsageReports">Create a metric usage report Documentation</a>
   */
