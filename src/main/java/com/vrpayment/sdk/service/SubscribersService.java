...
import com.vrpayment.sdk.model.Subscriber;
import com.vrpayment.sdk.model.SubscriberCreate;
import com.vrpayment.sdk.model.SubscriberListResponse;
import com.vrpayment.sdk.model.SubscriberSearchResponse;
import com.vrpayment.sdk.model.SubscriberUpdate;
...
public class SubscribersService extends BaseApi {
   ...
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#deleteSubscriptionsSubscribersId">Delete a subscriber Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getSubscriptionsSubscribers">List all subscribers Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getSubscriptionsSubscribersId">Retrieve a subscriber Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getSubscriptionsSubscribersSearch">Search subscribers Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#patchSubscriptionsSubscribersId">Update a subscriber Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#postSubscriptionsSubscribers">Create a subscriber Documentation</a>
   */
