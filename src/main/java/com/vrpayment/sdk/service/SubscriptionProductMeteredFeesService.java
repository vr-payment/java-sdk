...
import com.vrpayment.sdk.model.ProductMeteredFee;
import com.vrpayment.sdk.model.ProductMeteredFeeListResponse;
import com.vrpayment.sdk.model.ProductMeteredFeeSearchResponse;
import com.vrpayment.sdk.model.ProductMeteredFeeUpdate;
...
public class SubscriptionProductMeteredFeesService extends BaseApi {
   ...
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#deleteSubscriptionsProductsMeteredFeesId">Delete a metered fee Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getSubscriptionsProductsMeteredFees">List all metered fees Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getSubscriptionsProductsMeteredFeesId">Retrieve a metered fee Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getSubscriptionsProductsMeteredFeesSearch">Search metered fees Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#patchSubscriptionsProductsMeteredFeesId">Update a metered fee Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#postSubscriptionsProductsMeteredFees">Create a metered fee Documentation</a>
   */
