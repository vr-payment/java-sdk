...
import com.vrpayment.sdk.model.ApplicationUser;
import com.vrpayment.sdk.model.ApplicationUserCreate;
import com.vrpayment.sdk.model.ApplicationUserCreateWithMacKey;
import com.vrpayment.sdk.model.ApplicationUserListResponse;
import com.vrpayment.sdk.model.ApplicationUserSearchResponse;
import com.vrpayment.sdk.model.ApplicationUserUpdate;
import com.vrpayment.sdk.model.RestApiErrorResponse;
import com.vrpayment.sdk.model.RestApplicationUserMacKey;
import com.vrpayment.sdk.model.RestApplicationUserMacKeyCreated;
...
public class ApplicationUsersService extends BaseApi {
   ...
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#deleteApplicationUsersId">Delete an application user Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#deleteApplicationUsersUserIdKeysId">Deactivate an authentication key Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getApplicationUsers">List all application users Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getApplicationUsersId">Retrieve an application user Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getApplicationUsersSearch">Search application users Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getApplicationUsersUserIdKeys">List a user&#39;s authentication keys Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#patchApplicationUsersId">Update an application user Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#postApplicationUsers">Create an application user Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#postApplicationUsersUserIdKeys">Generate a new authentication key Documentation</a>
   */
