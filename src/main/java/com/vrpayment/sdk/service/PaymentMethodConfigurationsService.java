...
import com.vrpayment.sdk.model.PaymentMethodConfiguration;
import com.vrpayment.sdk.model.PaymentMethodConfigurationCreate;
import com.vrpayment.sdk.model.PaymentMethodConfigurationListResponse;
import com.vrpayment.sdk.model.PaymentMethodConfigurationSearchResponse;
import com.vrpayment.sdk.model.PaymentMethodConfigurationUpdate;
...
public class PaymentMethodConfigurationsService extends BaseApi {
   ...
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#deletePaymentMethodConfigurationsId">Delete a payment method configuration Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getPaymentMethodConfigurations">List all payment method configurations Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getPaymentMethodConfigurationsId">Retrieve a payment method configuration Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getPaymentMethodConfigurationsSearch">Search payment method configurations Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#patchPaymentMethodConfigurationsId">Update a payment method configuration Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#postPaymentMethodConfigurations">Create a payment method configuration Documentation</a>
   */
