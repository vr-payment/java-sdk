...
import com.vrpayment.sdk.model.Role;
import com.vrpayment.sdk.model.RoleCreate;
import com.vrpayment.sdk.model.RoleListResponse;
import com.vrpayment.sdk.model.RoleSearchResponse;
import com.vrpayment.sdk.model.RoleUpdate;
...
public class RolesService extends BaseApi {
   ...
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#deleteRolesId">Delete a role Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getRoles">List all roles Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getRolesId">Retrieve a role Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getRolesSearch">Search roles Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#patchRolesId">Update a role Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#postRoles">Create a role Documentation</a>
   */
