...
import com.vrpayment.sdk.model.SubscriptionAffiliate;
import com.vrpayment.sdk.model.SubscriptionAffiliateCreate;
import com.vrpayment.sdk.model.SubscriptionAffiliateListResponse;
import com.vrpayment.sdk.model.SubscriptionAffiliateSearchResponse;
import com.vrpayment.sdk.model.SubscriptionAffiliateUpdate;
...
public class SubscriptionAffiliatesService extends BaseApi {
   ...
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#deleteSubscriptionsAffiliatesId">Delete an affiliate Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getSubscriptionsAffiliates">List all affiliates Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getSubscriptionsAffiliatesId">Retrieve an affiliate Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getSubscriptionsAffiliatesSearch">Search affiliates Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#patchSubscriptionsAffiliatesId">Update an affiliate Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#postSubscriptionsAffiliates">Create an affiliate Documentation</a>
   */
