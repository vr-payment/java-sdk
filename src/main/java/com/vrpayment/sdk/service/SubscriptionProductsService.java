...
import com.vrpayment.sdk.model.ProductListResponse;
import com.vrpayment.sdk.model.ProductSearchResponse;
import com.vrpayment.sdk.model.RestApiErrorResponse;
import java.util.Set;
import com.vrpayment.sdk.model.SortingOrder;
import com.vrpayment.sdk.model.SubscriptionProduct;
import com.vrpayment.sdk.model.SubscriptionProductActive;
import com.vrpayment.sdk.model.SubscriptionProductCreate;
import com.vrpayment.sdk.model.SubscriptionProductRetirement;
import com.vrpayment.sdk.model.SubscriptionProductRetirementRequest;
...
public class SubscriptionProductsService extends BaseApi {
   ...
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getSubscriptionsProducts">List all products Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getSubscriptionsProductsId">Retrieve a product Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getSubscriptionsProductsSearch">Search products Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#patchSubscriptionsProductsId">Update a product Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#postSubscriptionsProducts">Create a product Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#postSubscriptionsProductsIdRetire">Retire a product Documentation</a>
   */
