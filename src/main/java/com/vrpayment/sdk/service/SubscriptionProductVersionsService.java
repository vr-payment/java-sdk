...
import com.vrpayment.sdk.model.ProductVersionListResponse;
import com.vrpayment.sdk.model.ProductVersionSearchResponse;
import com.vrpayment.sdk.model.RestApiErrorResponse;
import java.util.Set;
import com.vrpayment.sdk.model.SortingOrder;
import com.vrpayment.sdk.model.SubscriptionProductVersion;
import com.vrpayment.sdk.model.SubscriptionProductVersionPending;
import com.vrpayment.sdk.model.SubscriptionProductVersionRetirement;
import com.vrpayment.sdk.model.SubscriptionProductVersionRetirementRequest;
...
public class SubscriptionProductVersionsService extends BaseApi {
   ...
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getSubscriptionsProductsVersions">List all product versions Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getSubscriptionsProductsVersionsId">Retrieve a product version Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getSubscriptionsProductsVersionsSearch">Search product versions Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#patchSubscriptionsProductsVersionsId">Update a product version Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#postSubscriptionsProductsVersions">Create a product version Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#postSubscriptionsProductsVersionsIdActivate">Activate a product version Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#postSubscriptionsProductsVersionsIdRetire">Retire a product version Documentation</a>
   */
