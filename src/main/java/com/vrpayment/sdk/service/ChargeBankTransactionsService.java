...
import com.vrpayment.sdk.model.ChargeBankTransaction;
import com.vrpayment.sdk.model.ChargeBankTransactionListResponse;
import com.vrpayment.sdk.model.ChargeBankTransactionSearchResponse;
...
public class ChargeBankTransactionsService extends BaseApi {
   ...
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getPaymentBankTransactionsCharges">List all charge bank transactions Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getPaymentBankTransactionsChargesId">Retrieve a charge bank transaction Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getPaymentBankTransactionsChargesSearch">Search charge bank transactions Documentation</a>
   */
