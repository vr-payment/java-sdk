...
import com.vrpayment.sdk.model.ProductComponentGroupListResponse;
import com.vrpayment.sdk.model.ProductComponentGroupSearchResponse;
import com.vrpayment.sdk.model.RestApiErrorResponse;
import java.util.Set;
import com.vrpayment.sdk.model.SortingOrder;
import com.vrpayment.sdk.model.SubscriptionProductComponentGroup;
import com.vrpayment.sdk.model.SubscriptionProductComponentGroupUpdate;
...
public class SubscriptionProductComponentGroupsService extends BaseApi {
   ...
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#deleteSubscriptionsProductsComponentGroupsId">Delete a component group Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getSubscriptionsProductsComponentGroups">List all component groups Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getSubscriptionsProductsComponentGroupsId">Retrieve a component group Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getSubscriptionsProductsComponentGroupsSearch">Search component groups Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#patchSubscriptionsProductsComponentGroupsId">Update a component group Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#postSubscriptionsProductsComponentGroups">Create a component group Documentation</a>
   */
