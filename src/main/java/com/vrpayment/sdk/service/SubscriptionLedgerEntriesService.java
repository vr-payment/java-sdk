...
import com.vrpayment.sdk.model.SubscriptionLedgerEntry;
import com.vrpayment.sdk.model.SubscriptionLedgerEntryCreate;
import com.vrpayment.sdk.model.SubscriptionLedgerEntryListResponse;
import com.vrpayment.sdk.model.SubscriptionLedgerEntrySearchResponse;
...
public class SubscriptionLedgerEntriesService extends BaseApi {
   ...
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getSubscriptionsLedgerEntries">List all ledger entries Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getSubscriptionsLedgerEntriesId">Retrieve a ledger entry Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getSubscriptionsLedgerEntriesSearch">Search ledger entries Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#postSubscriptionsLedgerEntries">Create a ledger entry Documentation</a>
   */
