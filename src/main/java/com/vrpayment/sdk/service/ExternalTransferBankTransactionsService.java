...
import com.vrpayment.sdk.model.ExternalTransferBankTransaction;
import com.vrpayment.sdk.model.ExternalTransferBankTransactionListResponse;
import com.vrpayment.sdk.model.ExternalTransferBankTransactionSearchResponse;
...
public class ExternalTransferBankTransactionsService extends BaseApi {
   ...
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getPaymentBankTransactionsExternalTransfers">List all external transfer bank transactions Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getPaymentBankTransactionsExternalTransfersId">Retrieve an external transfer bank transaction Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getPaymentBankTransactionsExternalTransfersSearch">Search external transfer bank transactions Documentation</a>
   */
