...
import com.vrpayment.sdk.util.EncryptionUtil;
...
public class WebhookEncryptionKeysService extends BaseApi {
   ...
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getWebhooksEncryptionKeysId">Retrieve a webhook encryption key Documentation</a>
   */
