...
import com.vrpayment.sdk.model.CustomerAddress;
import com.vrpayment.sdk.model.CustomerAddressActive;
import com.vrpayment.sdk.model.CustomerAddressCreate;
import com.vrpayment.sdk.model.CustomerAddressListResponse;
import com.vrpayment.sdk.model.CustomerAddressSearchResponse;
...
public class CustomerAddressesService extends BaseApi {
   ...
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#deleteCustomersCustomerIdAddressesId">Delete a customer address Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getCustomersCustomerIdAddresses">List all customer addresses Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getCustomersCustomerIdAddressesId">Retrieve a customer address Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getCustomersCustomerIdAddressesSearch">Search customer addresses Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#patchCustomersCustomerIdAddressesId">Update a customer address Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#postCustomersCustomerIdAddresses">Create a customer address Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#postCustomersCustomerIdAddressesIdDefault">Set the default address for a customer Documentation</a>
   */
