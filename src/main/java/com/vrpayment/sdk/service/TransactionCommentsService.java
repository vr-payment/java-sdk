...
import com.vrpayment.sdk.model.TransactionComment;
import com.vrpayment.sdk.model.TransactionCommentActive;
import com.vrpayment.sdk.model.TransactionCommentCreate;
import com.vrpayment.sdk.model.TransactionCommentListResponse;
import com.vrpayment.sdk.model.TransactionCommentSearchResponse;
...
public class TransactionCommentsService extends BaseApi {
   ...
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#deletePaymentTransactionsTransactionIdCommentsId">Delete a transaction comment Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getPaymentTransactionsTransactionIdComments">List all transaction comments Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getPaymentTransactionsTransactionIdCommentsId">Retrieve a transaction comment Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getPaymentTransactionsTransactionIdCommentsSearch">Search transaction comments Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#patchPaymentTransactionsTransactionIdCommentsId">Update a transaction comment Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#postPaymentTransactionsTransactionIdComments">Create a transaction comment Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#postPaymentTransactionsTransactionIdCommentsIdPin">Pin a comment to the top Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#postPaymentTransactionsTransactionIdCommentsIdUnpin">Remove the pinned comment from the top Documentation</a>
   */
