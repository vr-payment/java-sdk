...
import com.vrpayment.sdk.model.ManualTask;
import com.vrpayment.sdk.model.ManualTaskListResponse;
import com.vrpayment.sdk.model.ManualTaskSearchResponse;
...
public class ManualTasksService extends BaseApi {
   ...
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getManualTasks">List all manual tasks Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getManualTasksId">Retrieve a manual task Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getManualTasksIdNotification">Retrieve a manual task&#39;s notification message Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getManualTasksSearch">Search manual tasks Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#postManualTasksIdActionActionId">Process a manual task&#39;s action Documentation</a>
   */
