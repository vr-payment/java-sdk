...
import com.vrpayment.sdk.model.ChargeFlow;
import com.vrpayment.sdk.model.ChargeFlowListResponse;
import com.vrpayment.sdk.model.ChargeFlowSearchResponse;
...
public class ChargeFlowsService extends BaseApi {
   ...
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getPaymentChargeFlows">List all charge flows Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getPaymentChargeFlowsId">Retrieve a charge flow Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getPaymentChargeFlowsSearch">Search charge flows Documentation</a>
   */
