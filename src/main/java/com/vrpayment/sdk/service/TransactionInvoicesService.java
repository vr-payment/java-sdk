...
import com.vrpayment.sdk.model.InvoiceListResponse;
...
import com.vrpayment.sdk.model.TransactionInvoice;
import com.vrpayment.sdk.model.TransactionInvoiceReplacement;
...
public class TransactionInvoicesService extends BaseApi {
   ...
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getPaymentTransactionsInvoices">List all transaction invoices Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getPaymentTransactionsInvoicesId">Retrieve a transaction invoice Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getPaymentTransactionsInvoicesIdCheckReplacementPossible">Check if a transaction invoice can be replaced Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getPaymentTransactionsInvoicesIdDocument">Retrieve an invoice document Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getPaymentTransactionsInvoicesSearch">Search transaction invoices Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#postPaymentTransactionsInvoicesIdDerecognize">Derecognize a transaction invoice Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#postPaymentTransactionsInvoicesIdMarkPaid">Mark a transaction invoice as paid Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#postPaymentTransactionsInvoicesIdReplace">Replace a transaction invoice Documentation</a>
   */
