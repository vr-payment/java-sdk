...
import com.vrpayment.sdk.model.PaymentLink;
import com.vrpayment.sdk.model.PaymentLinkCreate;
import com.vrpayment.sdk.model.PaymentLinkListResponse;
import com.vrpayment.sdk.model.PaymentLinkSearchResponse;
import com.vrpayment.sdk.model.PaymentLinkUpdate;
...
public class PaymentLinksService extends BaseApi {
   ...
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#deletePaymentLinksId">Delete a payment link Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getPaymentLinks">List all payment links Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getPaymentLinksId">Retrieve a payment link Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getPaymentLinksSearch">Search payment links Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#patchPaymentLinksId">Update a payment link Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#postPaymentLinks">Create a payment link Documentation</a>
   */
