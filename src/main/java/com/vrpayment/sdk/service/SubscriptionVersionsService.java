...
import com.vrpayment.sdk.model.SubscriptionVersionListResponse;
import com.vrpayment.sdk.model.SubscriptionVersionSearchResponse;
...
public class SubscriptionVersionsService extends BaseApi {
   ...
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getSubscriptionsVersions">List all subscription versions Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getSubscriptionsVersionsId">Retrieve a subscription version Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getSubscriptionsVersionsSearch">Search subscription versions Documentation</a>
   */
