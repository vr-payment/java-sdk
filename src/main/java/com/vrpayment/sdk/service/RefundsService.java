...
import com.vrpayment.sdk.model.RefundCreate;
import com.vrpayment.sdk.model.RefundListResponse;
import com.vrpayment.sdk.model.RefundSearchResponse;
...
public class RefundsService extends BaseApi {
   ...
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getPaymentRefunds">List all refunds Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getPaymentRefundsId">Retrieve a refund Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getPaymentRefundsIdDocument">Retrieve a refund document Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getPaymentRefundsSearch">Search refunds Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#postPaymentRefunds">Create a refund Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#postPaymentRefundsIdMarkFailed">Mark a refund as failed Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#postPaymentRefundsIdMarkSucceeded">Mark a refund as successful Documentation</a>
   */
