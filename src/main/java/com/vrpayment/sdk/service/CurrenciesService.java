...
import com.vrpayment.sdk.model.CurrencyListResponse;
import com.vrpayment.sdk.model.CurrencySearchResponse;
import com.vrpayment.sdk.model.RestApiErrorResponse;
import com.vrpayment.sdk.model.RestCurrency;
...
public class CurrenciesService extends BaseApi {
   ...
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getCurrencies">List all currencies Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getCurrenciesCode">Retrieve a currency Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getCurrenciesSearch">Search currencies Documentation</a>
   */
