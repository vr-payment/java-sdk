...
import com.vrpayment.sdk.model.SalesChannel;
import com.vrpayment.sdk.model.SalesChannelListResponse;
import com.vrpayment.sdk.model.SalesChannelSearchResponse;
...
public class PaymentSalesChannelsService extends BaseApi {
   ...
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getPaymentSalesChannels">List all payment sales channels. Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getPaymentSalesChannelsId">Retrieve a payment sales channel. Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getPaymentSalesChannelsSearch">Search payment sales channels. Documentation</a>
   */
