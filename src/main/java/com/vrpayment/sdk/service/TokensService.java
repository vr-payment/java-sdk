...
import com.vrpayment.sdk.model.Token;
import com.vrpayment.sdk.model.TokenCreate;
import com.vrpayment.sdk.model.TokenListResponse;
import com.vrpayment.sdk.model.TokenSearchResponse;
import com.vrpayment.sdk.model.TokenUpdate;
import com.vrpayment.sdk.model.TokenVersion;
...
public class TokensService extends BaseApi {
   ...
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#deletePaymentTokensId">Delete a token Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getPaymentTokens">List all tokens Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getPaymentTokensId">Retrieve a token Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getPaymentTokensIdActiveVersion">Retrieve the active token version Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getPaymentTokensSearch">Search tokens Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#patchPaymentTokensId">Update a token Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#postPaymentTokens">Create a token Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#postPaymentTokensIdCreateTransactionForTokenUpdate">Create a transaction for token update Documentation</a>
   */
