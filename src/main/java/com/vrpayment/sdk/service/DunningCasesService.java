...
import com.vrpayment.sdk.model.DunningCase;
import com.vrpayment.sdk.model.DunningCaseListResponse;
import com.vrpayment.sdk.model.DunningCaseSearchResponse;
...
public class DunningCasesService extends BaseApi {
   ...
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getPaymentDunningCases">List all dunning cases Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getPaymentDunningCasesId">Retrieve a dunning case Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getPaymentDunningCasesSearch">Search dunning cases Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#postPaymentDunningCasesIdSuspend">Suspend a dunning case Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#postPaymentDunningCasesInvoiceInvoiceId">Create a dunning case for an invoice Documentation</a>
   */
