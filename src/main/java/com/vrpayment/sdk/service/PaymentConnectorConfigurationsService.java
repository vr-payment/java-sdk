...
import com.vrpayment.sdk.model.PaymentConnectorConfiguration;
import com.vrpayment.sdk.model.PaymentConnectorConfigurationCreate;
import com.vrpayment.sdk.model.PaymentConnectorConfigurationListResponse;
import com.vrpayment.sdk.model.PaymentConnectorConfigurationSearchResponse;
import com.vrpayment.sdk.model.PaymentConnectorConfigurationUpdate;
...
public class PaymentConnectorConfigurationsService extends BaseApi {
   ...
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#deletePaymentConnectorConfigurationsId">Delete a payment connector configuration Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getPaymentConnectorConfigurations">List all payment connector configurations Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getPaymentConnectorConfigurationsId">Retrieve a payment connector configuration Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getPaymentConnectorConfigurationsSearch">Search payment connector configurations Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#patchPaymentConnectorConfigurationsId">Update a payment connector configuration Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#postPaymentConnectorConfigurations">Create a payment connector configuration Documentation</a>
   */
