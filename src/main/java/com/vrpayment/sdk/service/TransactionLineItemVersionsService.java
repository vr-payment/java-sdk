...
import com.vrpayment.sdk.model.LineItemVersionListResponse;
import com.vrpayment.sdk.model.LineItemVersionSearchResponse;
...
import com.vrpayment.sdk.model.TransactionLineItemVersionCreate;
...
public class TransactionLineItemVersionsService extends BaseApi {
   ...
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getPaymentTransactionsLineItemVersions">List all transaction line item versions Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getPaymentTransactionsLineItemVersionsId">Retrieve a transaction line item version Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getPaymentTransactionsLineItemVersionsSearch">Search transaction line item versions Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#postPaymentTransactionsLineItemVersions">Create a transaction line item version Documentation</a>
   */
