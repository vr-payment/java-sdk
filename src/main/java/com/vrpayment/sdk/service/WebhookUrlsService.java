...
import com.vrpayment.sdk.model.WebhookURLListResponse;
import com.vrpayment.sdk.model.WebhookURLSearchResponse;
import com.vrpayment.sdk.model.WebhookUrl;
import com.vrpayment.sdk.model.WebhookUrlCreate;
import com.vrpayment.sdk.model.WebhookUrlUpdate;
...
public class WebhookUrlsService extends BaseApi {
   ...
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#deleteWebhooksUrlsBulk">Delete multiple webhook URLs Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#deleteWebhooksUrlsId">Delete a webhook URL Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getWebhooksUrls">List all webhook URLs Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getWebhooksUrlsId">Retrieve a webhook URL Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getWebhooksUrlsSearch">Search webhook URLs Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#patchWebhooksUrlsBulk">Update multiple webhook URLs Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#patchWebhooksUrlsId">Update a webhook URL Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#postWebhooksUrls">Create a webhook URL Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#postWebhooksUrlsBulk">Create multiple webhook URLs Documentation</a>
   */
