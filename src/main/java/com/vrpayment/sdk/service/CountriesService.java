...
import com.vrpayment.sdk.model.CountryListResponse;
import com.vrpayment.sdk.model.CountrySearchResponse;
...
public class CountriesService extends BaseApi {
   ...
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getCountries">List all countries Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getCountriesCode">Retrieve a country Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getCountriesSearch">Search countries Documentation</a>
   */
