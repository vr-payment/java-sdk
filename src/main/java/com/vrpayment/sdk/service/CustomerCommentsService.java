...
import com.vrpayment.sdk.model.CustomerComment;
import com.vrpayment.sdk.model.CustomerCommentActive;
import com.vrpayment.sdk.model.CustomerCommentCreate;
import com.vrpayment.sdk.model.CustomerCommentListResponse;
import com.vrpayment.sdk.model.CustomerCommentSearchResponse;
...
public class CustomerCommentsService extends BaseApi {
   ...
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#deleteCustomersCustomerIdCommentsId">Delete a customer comment Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getCustomersCustomerIdComments">List all customer comments Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getCustomersCustomerIdCommentsId">Retrieve a customer comment Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#getCustomersCustomerIdCommentsSearch">Search customer comments Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#patchCustomersCustomerIdCommentsId">Update a customer comment Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#postCustomersCustomerIdComments">Create a customer comment Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#postCustomersCustomerIdCommentsIdPin">Pin a comment to the top Documentation</a>
   */
   ...
   * @throws ApiException if fails to make API call
   * 
   * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#postCustomersCustomerIdCommentsIdUnpin">Remove a pinned comment from the top Documentation</a>
   */
