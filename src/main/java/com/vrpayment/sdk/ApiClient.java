...
import com.vrpayment.sdk.auth.Authentication;
import com.vrpayment.sdk.auth.HttpBearerAuth;
...
public class ApiClient extends JavaTimeFormatter {
  ...
  private String basePath = "https://gateway.vr-payment.de/api/v2.0";
  protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://gateway.vr-payment.de/api/v2.0",
  ...
  */
  ...
  private void addMetaHeaders(ClassicRequestBuilder builder) {
      builder.addHeader("x-meta-sdk-version", "9.5.0");
      builder.addHeader("x-meta-sdk-language", "java");
      builder.addHeader("x-meta-sdk-provider", "vrpayment");
