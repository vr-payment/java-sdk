...
public class CustomerAddressService {
  ...
  /**
    ...
    * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#customer-address-service--count">Count Documentation</a>
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    * For more information visit this link.
    * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#customer-address-service--create">Create Documentation</a>
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    * For more information visit this link.
    * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#customer-address-service--delete">Delete Documentation</a>
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    * For more information visit this link.
    * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#customer-address-service--read">Read Documentation</a>
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    * For more information visit this link.
    * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#customer-address-service--search">Search Documentation</a>
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    * For more information visit this link.
    * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#customer-address-service--select-default-address">selectDefaultAddress Documentation</a>
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    * For more information visit this link.
    * @see <a href="https://gateway.vr-payment.de/doc/api/web-service#customer-address-service--update">Update Documentation</a>
