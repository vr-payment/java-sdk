...
import de.vr_payment.sdk.model.RenderedTerminalReceipt;
import de.vr_payment.sdk.model.ServerError;
import de.vr_payment.sdk.model.TerminalReceiptFetchRequest;
...
public class TransactionTerminalService {
  ...
  /**
    ...
    * @see <a href="https://gateway.vr-payment.de/doc/api/web-service/v1#transaction-terminal-service--fetch-receipts">Fetch Receipts Documentation</a>
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    * For more information visit this link.
    * @see <a href="https://gateway.vr-payment.de/doc/api/web-service/v1#transaction-terminal-service--till-connection-credentials">Create Till Connection Credentials Documentation</a>
