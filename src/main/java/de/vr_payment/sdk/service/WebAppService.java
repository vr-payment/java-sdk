...
import de.vr_payment.sdk.model.WebAppConfirmationRequest;
import de.vr_payment.sdk.model.WebAppConfirmationResponse;
...
public class WebAppService {
  ...
  /**
    ...
    * @see <a href="https://gateway.vr-payment.de/doc/api/web-service/v1#web-app-service--check-installation">Check Installation Documentation</a>
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    * For more information visit this link.
    * @see <a href="https://gateway.vr-payment.de/doc/api/web-service/v1#web-app-service--confirm">Confirm Documentation</a>
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    * For more information visit this link.
    * @see <a href="https://gateway.vr-payment.de/doc/api/web-service/v1#web-app-service--uninstall">Uninstall Documentation</a>
