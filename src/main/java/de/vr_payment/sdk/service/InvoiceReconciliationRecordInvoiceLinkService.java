...
import de.vr_payment.sdk.model.InvoiceReconciliationRecordInvoiceLink;
...
public class InvoiceReconciliationRecordInvoiceLinkService {
  ...
  /**
    ...
    * @see <a href="https://gateway.vr-payment.de/doc/api/web-service/v1#invoice-reconciliation-record-invoice-link-service--count">Count Documentation</a>
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    * For more information visit this link.
    * @see <a href="https://gateway.vr-payment.de/doc/api/web-service/v1#invoice-reconciliation-record-invoice-link-service--link">Link Invoice Documentation</a>
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    * For more information visit this link.
    * @see <a href="https://gateway.vr-payment.de/doc/api/web-service/v1#invoice-reconciliation-record-invoice-link-service--read">Read Documentation</a>
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    * For more information visit this link.
    * @see <a href="https://gateway.vr-payment.de/doc/api/web-service/v1#invoice-reconciliation-record-invoice-link-service--search">Search Documentation</a>
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    * For more information visit this link.
    * @see <a href="https://gateway.vr-payment.de/doc/api/web-service/v1#invoice-reconciliation-record-invoice-link-service--unlink-transaction">Unlink Invoice Documentation</a>
