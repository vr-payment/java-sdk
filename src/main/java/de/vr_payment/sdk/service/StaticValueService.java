...
import de.vr_payment.sdk.model.StaticValue;
...
public class StaticValueService {
  ...
  /**
    ...
    * @see <a href="https://gateway.vr-payment.de/doc/api/web-service/v1#static-value-service--all">All Documentation</a>
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    * For more information visit this link.
    * @see <a href="https://gateway.vr-payment.de/doc/api/web-service/v1#static-value-service--read">Read Documentation</a>
