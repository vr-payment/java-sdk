...
import de.vr_payment.sdk.model.SubscriptionLedgerEntry;
import de.vr_payment.sdk.model.SubscriptionLedgerEntryCreate;
...
public class SubscriptionLedgerEntryService {
  ...
  /**
    ...
    * @see <a href="https://gateway.vr-payment.de/doc/api/web-service/v1#subscription-ledger-entry-service--count">Count Documentation</a>
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    * For more information visit this link.
    * @see <a href="https://gateway.vr-payment.de/doc/api/web-service/v1#subscription-ledger-entry-service--create">Create Documentation</a>
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    * For more information visit this link.
    * @see <a href="https://gateway.vr-payment.de/doc/api/web-service/v1#subscription-ledger-entry-service--read">Read Documentation</a>
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    * For more information visit this link.
    * @see <a href="https://gateway.vr-payment.de/doc/api/web-service/v1#subscription-ledger-entry-service--search">Search Documentation</a>
