...
import de.vr_payment.sdk.model.LabelDescriptorGroup;
...
public class LabelDescriptionGroupService {
  ...
  /**
    ...
    * @see <a href="https://gateway.vr-payment.de/doc/api/web-service/v1#label-description-group-service--all">All Documentation</a>
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    * For more information visit this link.
    * @see <a href="https://gateway.vr-payment.de/doc/api/web-service/v1#label-description-group-service--read">Read Documentation</a>
