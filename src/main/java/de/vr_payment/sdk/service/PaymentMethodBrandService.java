...
import de.vr_payment.sdk.model.PaymentMethodBrand;
...
public class PaymentMethodBrandService {
  ...
  /**
    ...
    * @see <a href="https://gateway.vr-payment.de/doc/api/web-service/v1#payment-method-brand-service--all">All Documentation</a>
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    * For more information visit this link.
    * @see <a href="https://gateway.vr-payment.de/doc/api/web-service/v1#payment-method-brand-service--read">Read Documentation</a>
