...
import de.vr_payment.sdk.model.WebhookEncryptionPublicKey;
...
import de.vr_payment.sdk.util.EncryptionUtil;
...
public class WebhookEncryptionService {
  ...
  /**
    ...
    * @see <a href="https://gateway.vr-payment.de/doc/api/web-service/v1#webhook-encryption-service--read">Read Documentation</a>
        ...
        if (matcher.matches()) {
            ...
            if (cache.containsKey(publicKeyId)) {
                ...
                try {
                    ...
                    throw new VRPaymentSdkException(ErrorCode.WEBHOOK_ENCRYPTION_GENERAL_ERROR,
            ...
            throw new VRPaymentSdkException(WEBHOOK_ENCRYPTION_SIGNATURE_HEADER_INVALID, "Invalid webhook signature header. Expected format: 'algorithm=<algorithm>, keyId=<keyId>, signature=<signature>'");
        }
    }
