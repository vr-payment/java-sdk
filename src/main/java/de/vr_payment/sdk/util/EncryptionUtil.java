...
package de.vr_payment.sdk.util;
...
public class EncryptionUtil {
  ...
  private static PublicKey getPublicKey(String publicKeyId, byte[] publicKeyBytes,
    ...
    try {
      ...
      throw new VRPaymentSdkException(ErrorCode.WEBHOOK_ENCRYPTION_UNKNOWN_ALGORITHM,
          "Invalid public key with ID: " + publicKeyId);
    } catch (NoSuchAlgorithmException e) {
      throw new VRPaymentSdkException(ErrorCode.WEBHOOK_ENCRYPTION_UNKNOWN_ALGORITHM,
          "Unknown webhook signature encryption algorithm: " + signatureAlgorithm);
    } catch (NoSuchProviderException e) {
      throw new VRPaymentSdkException(ErrorCode.WEBHOOK_ENCRYPTION_UNKNOWN_PROVIDER,
